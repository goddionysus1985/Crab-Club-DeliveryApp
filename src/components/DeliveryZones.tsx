  ...
  const faqs = [
    {
      ...
      a: 'По центру Овідіополя доставка займає всього 5–15 хвилин, по всім іншим районам Овідіополя — 15–30 хвилин. У прилеглі села та райони — 40–60 хвилин.'
    },
    {
      q: 'Як отримати безкоштовну доставку?',
      a: 'Безкоштовна доставка активується автоматично (по Центру — від 500 грн, по Овідіополю — від 1000 грн, по селах — від 2700 грн). Також доступний швидкий самовивіз безпосередньо з ресторану!'
    },
    {
